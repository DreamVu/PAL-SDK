...
g++ 003_disparity.cpp ../lib/libPAL.so ../lib/libPAL_CAMERA.so  ../lib/libPAL_DEPTH.so  ../lib/libPAL_SSD.so `pkg-config --libs --cflags opencv`   -lv4l2 -lpthread -O3 -o 003_disparity.out -I../include/
