...
def drawOnImage(img, trackingData, ENABLEDEPTH=False, ENABLE3D=False):
...
def main():
	...
	key = ' '
	filter_spots = True#bool(loaded_prop["filter_spots"])
	...
	while key != 27:
		...
		drawOnImage(display, trackingData, enableDepth, enable3Dlocation);
