This folder contains three .cpp files, that serve as code samples - for displaying/saving the panorama videos.

launch ./compile.sh to compile all the three code samples.
...
--> 002_disparity_panorama 
	...
	Press 'F' key to toggle the vertical flip of panorama
	Press 'Y' key to toggle the colorspace : RGB or YUV444
	Press 'ESC' key to close the app.
...
--> 005_resolutions
	...
	Press 'N' key to toggle disparity normalization
	Press 'ESC' key to close the app.
	Press 1 to use full resolution
	Press 2 to use half resolution
	Press 3 to use one third of the resolution
