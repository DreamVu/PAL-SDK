...
CODE SAMPLE # 010: Object following panorama
...
{
    namedWindow( "PAL OBJECT_FOLLOWING", WINDOW_NORMAL ); // Create a window for display.
    ...
    resizeWindow("PAL OBJECT_FOLLOWING", width, height);
	...
	while(key != 27)
	{
        ...
        imshow( "PAL OBJECT_FOLLOWING", display);  
