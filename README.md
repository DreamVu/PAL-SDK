...
The Package can be downloaded directly from [here](https://github.com/DreamVu/ppa/raw/main/pal-usb/pal-usb.deb) and installed by running the below command from the location where it is downloaded,
