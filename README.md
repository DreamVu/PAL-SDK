...
The Package can be downloaded directly from [HERE](https://github.com/DreamVu/ppa/raw/main/palusb/PAL_USB_4.6_all.deb) or installed by adding the PPA. Steps for PPA are as follows:
